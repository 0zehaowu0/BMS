                            ...
                            <div class="layui-card-body">
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        ...
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="bookIndex" layuimini-content-href="bookIndex" data-title="图书管理" data-icon="fa fa-gears">
                                                <i class="fa fa-gears"></i>
                                                <cite>图书管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="noticeIndex" layuimini-content-href="noticeIndex" data-title="公告管理" data-icon="fa fa-file-text">
                                                <i class="fa fa-file-text"></i>
                                                <cite>公告管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="readerIndex" layuimini-content-href="readCardIndex" data-title="读者管理" data-icon="fa fa-dot-circle-o">
