...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="cardnumber" lay-verify="required" value="${info.cardnumber}"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" name="number" value="${info.number}" class="layui-input readonly-input" readonly>
        </div>
    </div>
